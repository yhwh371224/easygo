...
# -------------------------------
INDICATOR_MEANING = {
    "SOFR": "은행간 달러 금리: Repo 시장 금리. 금리가 낮으면 은행들이 자금을 적극적으로 시장에 풀고 있거나 또는 시장에 현금이 부족해서 단기 금리를 내리고 있는 상황으로 봐야 한다",
    "RRP": "연준 역환매(RRP) 잔액: 은행이 안전자산으로 이동. RRP 수치가 높으면 시장에 유동성이 낮아졌다는 의미로 해석, 반대로 수치가 낮으면 유동성이 좋다고 해석",
    "10Y_Treasury": "미국 10년물 국채 금리: 장기 금리 벤치마크. 국채금리가 높으면 유동성이 좋지 않고 국채금리가 낮으면 유동성이 좋아진다.",
