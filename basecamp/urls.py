...
urlpatterns = [
    ...
    path('airport-transfers-airport-hotel/', views.airport_hotel, name='airport_hotel'),
    path('airport-transfers-artarmon/', views.artarmon, name='artarmon'),
    ...
    path('airport-transfers-hotel/', views.hotel, name='hotel'),
    ...
    path('inquiry1_full/', views.inquiry1_full, name="inquiry1_full"),
    ...
    path('inquiry_details1_full/', views.inquiry_details1_full, name='inquiry_details1_full'),
