...
urlpatterns = [
    ...
    path('airport-shuttle-<slug:suburb>/', RedirectView.as_view(url='/sydney_airport_shuttle/%(suburb)s/', permanent=True), name='airport_shuttle_suburb'),
    path('airport-transfer-<slug:suburb>/', RedirectView.as_view(url='/sydney_airport_transfer/%(suburb)s/', permanent=True), name='airport_transfer_suburb'),
    path('airport-transfers-<slug:suburb>/', RedirectView.as_view(url='/sydney_airport_transfer/%(suburb)s/', permanent=True), name='old_airport_transfers_redirect'),
    path('sydney_airport_shuttle/<slug:suburb>/', views.airport_shuttle, name='sydney_airport_shuttle_suburb'),
    path('sydney_airport_transfer/<slug:suburb>/', views.airport_transfer, name='sydney_airport_transfer_suburb'),
