...
urlpatterns = [
    ...
    path('airport-transfers-airport-hotel/', views.artarmon, name='airport_hotel'),
    ...
    path('airport-transfers-hotel/', views.artarmon, name='hotel'),
    ...
    path('airport-transfers-sydney-hotel/', views.artarmon, name='sydney_hotel'),
