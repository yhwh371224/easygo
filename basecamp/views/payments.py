...
def _build_booking_row(booking, apply_gst_flag, surcharge_input, toll_input):
    ...
    return {
        ...
        "extra_stop_addresses": booking.extra_stop_addresses or [],
...
def _build_multi_context(bookings, params, inv_no, today, DEFAULT_BANK):
    ...
    context = {
        ...
        "booker_contact": first_booking.booker_contact if first_booking else "",
    ...
    if user.return_pickup_time == "x":
        ...
        context = {
            **shared,
            ...
            "booker_contact": user1.booker_contact,
            ...
            "extra_stop_addresses": user1.extra_stop_addresses or [],
