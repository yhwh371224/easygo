...
class Inquiry(models.Model):
    ...
    pickup_date = models.DateField(verbose_name='pickup_date', blank=False, default=datetime.date.today)
    ...
    return_pickup_date = models.DateField(blank=True, null=True, default=datetime.date.today)
