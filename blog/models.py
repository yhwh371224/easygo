...
class Inquiry(models.Model):
    ...
    cruise = models.BooleanField(default=False, blank=True, null=True)  
    cancelled = models.BooleanField(default=False, blank=True, null=True)    
    private_ride = models.BooleanField(default=False, blank=True, null=True)
    reminder = models.BooleanField(default=False, blank=True, null=True)
    sent_email = models.BooleanField(default=False, blank=True, null=True)
